                            ...
                            <li class="dash-item dash-hasmenu <?php echo e((Request::segment(1) == 'holiday-calender' || Request::segment(1) == 'reports-monthly-attendance' ||
                                ...
                                <ul class="dash-submenu">
                                    ...
                                    <li class="dash-item <?php echo e((request()->is('account-assets*') ? 'active' : '')); ?>">
                                            <a class="dash-link" href="<?php echo e(route('fixedasset.index')); ?>"><?php echo e(__('Fixed Asset Setup ')); ?></a>      
                                        </li>     
...
<?php /**PATH C:\another_xampp\htdocs\ssb-finance-org\resources\views/partials/admin/menu.blade.php ENDPATH**/ ?>