...
@section('page-title')
{{__('Fixed Asset Management')}}
@endsection
@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{route('dashboard')}}">{{__('Dashboard')}}</a></li>
    <li class="breadcrumb-item">{{__('Fixed Asset')}}</li>
@endsection
